<template>
  <el-dialog title="编辑任务" :visible.sync="dialogFormVisible" top="8vh" :close-on-click-modal='false'>
  ...
  export default {
    ...
    methods: {
      show(params) {
        ...
        this.dataForm.jobName = params.jobName;
        this.dataForm.jobGroup = params.jobGroup;
        this.dataForm.beanClass = params.beanClass;
        this.dataForm.cronExpression = params.cronExpression;
        this.dataForm.description = params.description;
        this.dataForm.isConcurrent = params.isConcurrent;
        this.dialogFormVisible = true;
      },
      save() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            job.updateJob(this.dataForm).then(response => {
